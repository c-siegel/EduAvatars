...
export function ProjectCard({ project }: { project: Project }) {
  ...
  const exportMutation = useMutation({
    mutationFn: () => projectsApi.exportYaml(project.id, `${project.title}.yml`),
  });
      ...
      <div className={styles.footer}>
        ...
        <div className={styles.actionsDesktop}>
          ...
          <button
            ...
            aria-label={t("overview.card.export")}
            title={t("overview.card.export")}
          >
            <Download size={16} />
          </button>
        </div>
          ...
          {menuOpen && (
            <div className={styles.menu} role="menu">
              ...
              <button
                ...
                role="menuitem"
              >
                <Download size={14} /> {t("overview.card.export")}
              </button>
              <button
